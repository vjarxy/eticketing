<x-layouts.app>
    ...
    <!-- Converted from Bootstrap to Tailwind CSS, updated to use x-layouts.app, removed password fields as UserController sets default password -->
    <div class="max-w-7xl mx-auto px-4">
        <div class="max-w-2xl mx-auto">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900"><i class="fas fa-user-plus mr-2"></i>Tambah User</h2>
                    <p class="text-gray-600">Buat pengguna baru</p>
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <select
                                ...
                                <option value="pengunjung" {{ old('role') == 'pengunjung' ? 'selected' : '' }}>
                                    Pengunjung
                                </option>
                            ...
                            @error('role')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <p class="text-sm text-gray-500 mt-1">Password default: password123</p>
                        </div>
